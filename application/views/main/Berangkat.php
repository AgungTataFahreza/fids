    ...
    <div class="container-fluid" >
        ...
        <div class="row" style="margin-left:1px;display:inline">
            <div class="col-md-1 col-lg-1">
                <img style="padding:20px;border: 2px solid #ffffff;border-radius:15px;" src="<?= base_url() ?>images/takeoff.png">
            </div>
            <div class="col-md-2 col-lg-2" style="vertical-align:center;">
                <h1 class='judul'>KEBERANGKATAN</h1>
            </div>
            ...
            foreach ($keberangkatan as $data) {
                ...
                <tr <?= $class ?> style="font-size:30px;">
                    ...
                    <td style="text-align: center;">
                        <div 
                            <?php 
                                if($data->status_indo == "KE RUANG TUNGGU" || $data->status_indo == "BOARDING" || $data->status_indo == "PANGGILAN KEDUA" || $data->status_indo =="PANGGILAN TERAKHIR")
        ...
        <table border="1">
            ...
            $warna = 0;
            foreach ($keberangkatan as $dataa) {
                if ($warna % 2 == 0) {
                    $class = "class='baris2'";
                } else {
                    $class = "class='baris1'";
                ...
                <tr <?= $class ?> style="font-size:30px;">
                    ...
                    <td style="text-align: center;">
                        <div 
                            <?php 
                                if($dataa->status_english == "WAITING ROOM" || $dataa->status_english == "BOARDING" || $dataa->status_english == "SECOND CALL" || $dataa->status_english == "FINAL CALL")
                                { echo'class="green-badge"';}
                ...
                <div class="row" style="margin-left:1px;display:inline">
                    <div class="col-md-11 col-lg-11">
                        <marquee>
                            ...
                            <h1 style="color:white;"><img src="<?= base_url() ?>images/Logo_Dishub.png" alt="" width="50px" height="50px"> <?php if(isset($_SESSION['running_text'])){ echo $_SESSION['running_text'];} else {echo $running_text; $_SESSION['running_text']=$running_text;} ?></h1>
                        </marquee>
                    </div>
                    <div class="col-md-1 col-lg-1">
...
var toogle = "0";
    ...
    { 
        ...
        if(toogle=='0')
        {
            ...
            $('#isii').load('<?=base_url()?>Overview/Keberangkatan #isii',function () 
            {
                $(this).unwrap();
            });
        ...
        else if(toogle=='1')
        {
            ...
            $("#databmkg_indo").hide();
            $("#databmkg_eng").show();
            $('#isi').load('<?=base_url()?>Overview/Keberangkatan #isi',function () 
            {
                $(this).unwrap();
            });
