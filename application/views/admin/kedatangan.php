    ...
    <section class="content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <br>
                            <a href="cursor: pointer;" class="btn btn-primary waves-effect m-r-20" data-toggle="modal" data-target="#tambah" onclick="form('tambah');"><i class="material-icons">add</i>Tambah</a>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $data) {
                                            $hasil = $kedatangan[$data->flight_number];
                                            $jlh_hasil = count($hasil);
                                            //var_dump($hasil);
                                            //echo "<br><br>";
                                            //var_dump();
                                            //echo "<br><br>";
                                            ...
                                            <tr align="center" ">
                                                <td><?= $no ?>.</td>
                                                <td>
                                                  <img src=" <?= base_url() ?>image/<?= $hasil[$jlh_result]->image ?>" width="150" height="50">
                                                </td>
                                                <td><?= $hasil[$jlh_result]->flight_number ?></td>
                                                <td><?= $hasil[$jlh_result]->nama_kota ?></td>
                                                <td align="left">
                                                    <?php
                                                        $gabung_hari = [];
                                                        $gabung_waktu = [];
                                                        for ($i = 0; $i < $jlh_hasil; $i++) {
                                                            echo "<div>" . hari_indo($hasil[$i]->hari) . "</div>";
                                                            echo " [" . $hasil[$i]->waktu . "]";
                                                            ?>
                                                        <button class="btn btn-success btn-xs waves-effect" data-toggle="modal" data-target="#status" onclick="status('<?= $hasil[$i]->id ?>','<?= $hasil[$i]->nama_penerbangan ?>','<?= $hasil[$i]->flight_number ?>','<?= $hasil[$i]->nama_kota ?>','<?= $hasil[$i]->waktu ?>','<?= $hasil[$i]->est ?>','<?= $hasil[$i]->remark ?>');"><i class="material-icons">info</i> STATUS</button><br>
                                                    <?php
                                                            $gabung_hari[] = $hasil[$i]->hari;
                                                            $gabung_waktu[] = $hasil[$i]->waktu;
                                                        }
                                                        $gabung_hari = implode(",", $gabung_hari);
                                                        $gabung_waktu = implode(",", $gabung_waktu);
                                                        //var_dump($gabung_waktu);
                                                        ?>
                                                </td>
                                                <td>
                                                    <a class="btn btn-warning" data-toggle="modal" data-target="#edit" onclick="form('edit');update('<?= $hasil[$jlh_result]->id_penerbangan ?>','<?= $hasil[$jlh_result]->flight_number ?>','<?= $hasil[$jlh_result]->id_kota ?>','<?= $gabung_hari ?>','<?= $gabung_waktu ?>');"><i class="material-icons">edit</i>Edit</a>
                                                    <a href="<?php echo base_url() ?>Admin/DeleteKedatangan/<?= $hasil[$jlh_result]->flight_number ?>" class="btn btn-danger text-light" onclick="return confirm_delete()" title="Hapus Data Keberangkatan"><i class="material-icons">delete</i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="body">
                            <form action="<?= base_url() ?>Admin/update_status/kedatangan" method="post" enctype="multipart/form-data">
                                <div class="body">
                                    <input type="hidden" id="id_delay" name="id">
                                    ...
                                    <div id="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input readonly type="text" name="nama_penerbangan" id="penerbangan_delay" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input readonly type="text" name="no_penerbangan" id="no_penerbangan_delay" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input readonly type="text" name="kota" id="kota_delay" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="add" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input readonly type="time" name="jadwal" id="jam_delay" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <select name="remark" id="keterangan" class="form-control">
                                                <?php 
                                                    ...
                                                    {
                                                    ?>
                                                        <option value="<?=$statuss->id?>"><?=$statuss->status_english?></option>
                                                    <?php } ?>
                                        </select>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="tambah" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="body">
                            <form action="<?php echo base_url() ?>Admin/TambahKedatangan" id="frmFileUpload" method="post" enctype="multipart/form-data">
                                <div class="body">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
                                        <label for="gol">Penerbangan</label>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="demo-checkbox">
                                                    ...
                                                    <input type="checkbox" id="md_checkbox_16" class="filled-in chk-col-deep-orange" onchange="toggle('tambah');tambah('tambah');loop_hari('tambah');">
        ...
        <div class="modal fade" id="edit" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Edit Keberangkatan</h4>
                    </div>
                    <div class="modal-body">
                        <div class="body">
                            <form action="<?php echo base_url() ?>Admin/EditKedatangan" method="post" enctype="multipart/form-data">
                                <div class="body">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="kode_penerbangan" id="kode_penerbangan" class="form-control" placeholder="Kode Penerbangan">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="kota">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="demo-checkbox">
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_senin" id="md_checkbox_8" class="filled-in chk-col-red">
                                                    <label for="md_checkbox_8">SENIN</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_selasa" id="md_checkbox_9" class="filled-in chk-col-pink">
                                                    <label for="md_checkbox_9">SELASA</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_rabu" id="md_checkbox_10" class="filled-in chk-col-purple">
                                                    <label for="md_checkbox_10">RABU</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_kamis" id="md_checkbox_11" class="filled-in chk-col-deep-purple">
                                                    <label for="md_checkbox_11">KAMIS</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_jumat" id="md_checkbox_12" class="filled-in chk-col-indigo">
                                                    <label for="md_checkbox_12">JUM'AT</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_sabtu" id="md_checkbox_13" class="filled-in chk-col-blue">
                                                    <label for="md_checkbox_13">SABTU</label>
                                                    <input type="checkbox" onchange="tambah('edit');loop_hari('edit');" name="hari_minggu" id="md_checkbox_14" class="filled-in chk-col-light-blue">
                                                    <label for="md_checkbox_14">MINGGU</label>
                                                    <input type="checkbox" id="md_checkbox_15" class="filled-in chk-col-deep-orange" onchange="toggle('edit');tambah('edit');loop_hari('edit');">
                                                    <label for="md_checkbox_15">Pilih Semua</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" id="contoh" name="contoh">
                                    <input type="hidden" id="hari_edit" name="hari">
                                    <button type="submit" class="btn btn-primary">Simpan</button>
                                    <button type="button" class="btn btn-light" data-dismiss="modal">Batal</button>
                                </div>
                            </form>
...
<script language="JavaScript">
    function status(id, flight, flight_number, city, time, est, keterangan) {
        document.getElementById("id_delay").value = id;
        document.getElementById("penerbangan_delay").value = flight;
        document.getElementById("no_penerbangan_delay").value = flight_number;
        document.getElementById("kota_delay").value = city;
        document.getElementById("jam_delay").value = time;
    ...
    function toggle(data) {
        ...
        var a = null;
        if (data == "tambah") {
            var a = document.getElementById("md_checkbox_16").checked;
        } else {
            var a = document.getElementById("md_checkbox_15").checked;
        }
        var b = null;
        if (a == false) {
            b = false;
        ...
        document.getElementById("md_checkbox_8").checked = b;
        document.getElementById("md_checkbox_9").checked = b;
        document.getElementById("md_checkbox_10").checked = b;
        document.getElementById("md_checkbox_11").checked = b;
        document.getElementById("md_checkbox_12").checked = b;
        document.getElementById("md_checkbox_13").checked = b;
        document.getElementById("md_checkbox_14").checked = b;
    }
