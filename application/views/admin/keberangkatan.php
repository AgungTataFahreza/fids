                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $data) {
                                            $hasil = $keberangkatan[$data->flight_number];
                                            ...
                                            <tr align="center">
                                                ...
                                                <td align="left">
                                                    <?php
                                                        ...
                                                        for ($i = 0; $i < $jlh_hasil; $i++) {
                                                            ...
                                                            echo "[" . $hasil[$i]->waktu . "]";
                                                            ?>
                                                        <button class="btn btn-success btn-xs waves-effect" data-toggle="modal" data-target="#status" onclick="status('<?= $hasil[$i]->id ?>','<?= $hasil[$i]->nama_penerbangan ?>','<?= $hasil[$i]->flight_number ?>','<?= $hasil[$i]->nama_kota ?>','<?= $hasil[$i]->waktu ?>','<?= $hasil[$i]->est ?>','<?= $hasil[$i]->remark ?>','<?= $hasil[$i]->gate?>');"><i class="material-icons">info</i> STATUS</button><br>
                                                    <?php
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url() ?>Admin/DeleteKeberangkatan/<?= $hasil[$jlh_result]->flight_number ?>" class="btn btn-danger text-light" onclick="return confirm_delete()" title="Hapus Data Keberangkatan"><i class="material-icons">delete</i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="body">
                            <form action="<?= base_url() ?>Admin/update_status/keberangkatan" method="post" enctype="multipart/form-data">
                                <div class="body">
        ...
        <div class="modal fade" id="edit" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="body">
                            <form action="<?php echo base_url() ?>Admin/EditKeberangkatan" method="post" enctype="multipart/form-data">
                                <div class="body">
...
<script language="JavaScript">
    ...
    function status(id, flight, flight_number, city, time, est, keterangan, gate) {
