                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <form action="<?= base_url() ?>Admin/EditKedatangan" id="frmFileUpload" method="post" enctype="multipart/form-data">
                                <div class="body">
                                            ...
                                            <div class="form-line">
                                                <select name="id_penerbangan" id="" class="form-control">
                                                    ...
                                                    foreach ($penerbangan as $penerbangann) {
                                                        if ($penerbangann->id == $kedatangan->id_flight) {
                                                            $s = 'selected';
                                                        } else {
                                                            $s = '';
                                                        }
                                            ...
                                            <div class="form-line">
                                                <select name="id_kota" id="" class="form-control">
                                                    ...
                                                    foreach ($kota as $kotaa) {
                                                        if ($kotaa->id == $kedatangan->id_city) {
                                                            $s = 'selected';
                                                        } else {
                                                            $s = '';
                                                        }
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="date" name="tanggal" value="<?= $kedatangan->tanggal ?>" class="form-control" placeholder="jadwal">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="time" name="waktu" value="<?= $kedatangan->waktu ?>" class="form-control" placeholder="jadwal">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select name="keterangan" id="keterangan" class="form-control">
                                                    <option value="MENDARAT" <?php if ($kedatangan->remark == 'MENDARAT') {
                                                                                    echo 'selected';
                                                                                } ?>>MENDARAT
                                                    </option>
                                                    <option value="TERLAMBAT" <?php if ($kedatangan->remark == 'TERLAMBAT') {
                                                                                    echo 'selected';
                                                                                } ?>>TERLAMBAT
                                                    </option>
                                                </select>
                                    ...
                                    <div id="est" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="time" value="<?= $kedatangan->est ?>" name="est" class="form-control" placeholder="Est">
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Simpan</button>
                                    <a href="<?= base_url() ?>Admin/kedatangan" class="btn btn-light">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
